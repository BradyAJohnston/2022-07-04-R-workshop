...
into a pair of new variables, pivoting from a wide-format table to a
long-format table (to 'tidy' data). One variable represents the column
names as values, and the other variable contains the values previously
